...
import TimesheetEntriesStore from "./TimesheetEntriesStore";
...
export default class RootStore {
  ...
  timesheetEntries: TimesheetEntriesStore;
  ...
  constructor() {
    ...
    this.registerStore(TimesheetEntriesStore, "timesheetEntries");
